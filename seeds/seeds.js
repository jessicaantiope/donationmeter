exports.seed = function (knex, Promise) {
  return knex('donors').del()
    .then(function () {
      return Promise.all([
        knex('donors').insert({id: 1, name: 'Edi', amount: '2'}),
        knex('donors').insert({id: 2, name: 'Maia', amount: '4'}),
        knex('donors').insert({id: 3, name: 'Jess', amount: '3'}),
        knex('donors').insert({id: 4, name: 'James', amount: '7'}),
        knex('donors').insert({id: 5, name: 'Nick', amount: '2'}),
        knex('donors').insert({id: 6, name: 'Phuong', amount: '4'}),
        knex('donors').insert({id: 7, name: 'Mel', amount: '4'}),
        knex('donors').insert({id: 8, name: 'Guy', amount: '2'}),
        knex('donors').insert({id: 9, name: 'Hayden', amount: '3'}),
        knex('donors').insert({id: 10, name: 'Brian', amount: '2'}),
        knex('donors').insert({id: 11, name: 'Harrison', amount: '4'}),
        knex('donors').insert({id: 12, name: 'Ross', amount: '1'}),
